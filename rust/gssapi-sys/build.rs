...
fn main() {
    ...
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_function("krb5_cc_set_default_name")
        .allowlist_function("krb5_cc_initialize")
        .allowlist_function("krb5_cc_store_cred")
        .allowlist_function("krb5_cc_cache_match")
        .allowlist_function("krb5_cc_new_unique")
        .allowlist_function("krb5_cc_switch")
        .allowlist_function("krb5_cc_get_principal")
        .allowlist_function("krb5_cc_retrieve_cred")
